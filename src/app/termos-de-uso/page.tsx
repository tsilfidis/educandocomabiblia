  ...
  return (
    <div>
      ...
      <p>
        ...
        informações. É uma condição de uso deste site que toda a informação que
        você forneça seja correta, atualizada e completa. Se a Empresa acreditar
        que a informação disponibilizada não é correta, atualizada ou completa,
        temos o direito de recusar o seu acesso a esse site ou qualquer um de
      ...
      <p>
        ...
        outra, ou (ii) fazer um frame deste site em outro ou (iii) fazer um
        hiperlink para este site sem a autorização expressa prévia e escrita de
        um representante da nossa Empresa. Para efeitos desses Termos de Uso,
        “associar a marca da nossa Empresa” significa expor nome, logo, marca
        comercial ou outros meios de atribuição ou identificação em fonte de
        maneira que dê ao usuário a impressão de que tal fonte tem o direito de
        expor, publicar ou distribuir este site ou o conteúdo disponibilizado
      ...
      <p>
        ...
        operações futuras da Empresa. Nossa Empresa tratará qualquer informação
        pessoal que você submeter por esse site de acordo com as{" "}
        <a
      ...
      <p>
        ...
        usado para substituir quaisquer relatórios, declarações ou avisos dados
        pela Empresa. Investidores, colaboradores e outros devem usar o Conteúdo
        da mesma maneira que qualquer outro ambiente educacional e não deve
        confiar somente no Conteúdo em detrimento de seu próprio julgamento
        profissional. A informação obtida ao usar este site não é completa e não
        cobre todas as questões, tópicos ou fatos que possam ser relevantes para
        seus objetivos.
      </p>
      <p>
        ...
        SITE E SERVIDOR QUE O TORNA DISPONÍVEL ESTÃO LIVRES DE VÍRUS OU OUTROS
        ...
        MUDANÇAS OU MELHORIAS A QUALQUER MOMENTO. VOCÊ, E NÃO A NOSSA EMPRESA,
      ...
      <p>
        ...
        julgamento, prêmios, custo, despesas e honorários advocatícios das
        ...
        da informação contida neste site. Marcas Registradas Marcas e logos
        presentes neste site são propriedade da Empresa ou da parte que as
        disponibilizaram para a Empresa. A Empresa e as partes que
        disponibilizaram marca e logo detém todos os direitos sobre as mesmas.
      </p>
      <h2>Informação provida pelo usuário</h2>Você não pode publicar enviar,
      apresentar ou fazer conexão a esse site qualquer material que:
      <br />
      - você não tenha o direito de postar, incluindo material de propriedade de
      terceiros;
      <br />
      ...
      tipo;
      <br />
      - infrinja qualquer propriedade intelectual ou outro direito de pessoa ou
      entidade, incluindo violações de direitos autorais, marca registrada ou
      direitos de publicidade;
      <br />
      - violam qualquer lei ou podem ser considerados para violar a lei;
      <br />
      - personifique ou deturpar sua conexão com qualquer entidade ou pessoa; ou
      ainda manipula títulos ou identificadores para encobrir a origem do
      conteúdo;
      <br />
      ...
      patrocinadores e/ou solicitar bens e serviços) exceto que especificamente
      autorizado neste site;
      <br />
      - solicitar fundos, divulgações ou patrocinadores;
      <br />
      - inclua programas com vírus, worms e/ou Cavalos de Tróia ou qualquer
      outro código, arquivo ou programa de computador destinado a interromper,
      destruir ou limitar a funcionalidade de qualquer software ou hardware de
      computador ou telecomunicações;
      <br />
      ...
      em tempo real neste site;
      <br />
      - inclua arquivos em formato MP3;
      <br />
      - desobedeça qualquer política ou regra estabelecida de tempos em tempos
      para o uso desse site ou qualquer rede conectada a ele; ou
      ...
      <p>
        ...
        INVESTIGAÇÕES E/OU DE AÇÕES TOMADAS RESULTANTES DE INVESTIGAÇOES TANTO
